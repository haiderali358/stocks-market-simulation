...
app.config['CACHE_REDIS_URL'] = env("CACHE_REDIS_URL")
cache = Cache(app)
redis_conn = Redis(host='localhost', port=6379, db=0)
app.config['JWT_SECRET_KEY'] = env("SECRET_KEY")
app.config['JWT_ACCESS_TOKEN_EXPIRES'] = timedelta(int(env("JWT_ACCESS_TOKEN_EXPIRES")))
...
api.add_resource(TransactionsDataViewDouble,
                 "/transaction/data/view/<int:user_id>/<string:start_timestamp>/<string:end_timestamp>")
